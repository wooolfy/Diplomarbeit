...
%           \end{itemize}
      ...
      Dokumentation werfen zu müssen. Allerdings macht das arbeiten mit Visual
      Paradigm in Kombination mit Accelo als Transformationstool nicht viel
      Sinn, da beim Export der Diagramme in XML Files Informationen verloren
      gehen. Beim Import in Acceleo beispielsweise fehlen die Namen bzw.
      Bezeichnungen der Diagramme so wie Zusammenhänge der einzelnen
      Diagrammarten, die jedoch vorher definiert wurden. Damit ist Visual
      Paradigm für den Zweck der Codegenerierung in Acceleo unbrauchbar.
      ...
      Bedienung von MagicDraw wesentlich komplexer und unübersichtlicher als bei
      Visual Paradigm. Die Einarbeitungszeit ist bei dieser Komplexität
      exponentiell größer. Daher verzögerte sich die Erstellung der Diagramme
      sehr. Was in Visual Paradigm in Stunden machbar war, dauerte hier Tage.
      Schlechte Navigation, unübersichtliche Menüs und wenig Dokumentation zur
      Software, aber dafür volle Kompatibilität zu Acceleo.
