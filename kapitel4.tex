...
% 			>{\columncolor{hellgrau}}c}
        ...
        Als nächstes zu definieren ist das View Metamodell. Hier wird
        festgelegt, welche Elemente zur Dartellung verwendet werden und wie der
        Benutzer die dartestellten Elemente manipulieren darf
        (Abbildung \ref{fig:profile_view}).
        
        Basiselement ist der \texttt{View}. Ihm werden beliebig viele
        View-Elemente zugeordnet. Weiterhin im Modell enthalten sind
        \texttt{OutputElemente} für die übergebenden Modelldaten in grafischer
        Form und den \texttt{InputElementen}, die Werte des Pageflow-Kontextes
        durch Benutzereingaben aktualisieren. Daneben gibt es
