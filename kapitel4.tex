...
%         \end{itemize}
		...
		\begin{itemize}
          \item 1(/2) Funktion(en) vom Kapitel Funktionsumfang auswählen. 
          \item Nochmal näher beschreiben.
        \end{itemize}
        
        Ein realistischer Geschäftsvorfall soll als Grundlage für die Umsetzung
        des Prototypen dienen.
        
        \subsection{Vorgaben}
        
        Es soll gezeigt werden, dass mit MDA die Umsetzung des 
        Geschäftsvorfalles technisch möglich ist. Ebenso sollen die Grenzen
        der Technologie erforscht werden. Dabei soll gezeigt werden, dass
        folgende Artefakte aus dem Modell erzeugt werden könne: 
        \begin{itemize}
          \item Persistenz
